	...
	double epsBarzz = 0.0    //epsilonBar[i][2][2];
	double epsBarxy = epsilonBar[i][0][1];
	double epsBarxz = 0.0    //epsilonBar[i][0][2];
	double epsBaryz = 0.0    //epsilonBar[i][1][2];
	double epsBaryx = epsilonBar[i][1][0];
	double epsBarzx = 0.0    //epsilonBar[i][2][0];
	double epsBarzy = 0.0    //epsilonBar[i][2][1];
