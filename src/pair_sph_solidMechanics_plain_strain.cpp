...
#include "math.h"
#include "stdlib.h"
#include "pair_sph_solidMechanics_plain_strain.h"
#include "atom.h"
#include "force.h"
#include "comm.h"
...
PairSPHSolidMechanicsPlainStrain::PairSPHSolidMechanicsPlainStrain(LAMMPS *lmp) : Pair(lmp)
{
  restartinfo = 0;
...
PairSPHSolidMechanicsPlainStrain::~PairSPHSolidMechanicsPlainStrain() {
  if (allocated) {
...
void PairSPHSolidMechanicsPlainStrain::init_style() {
...
void PairSPHSolidMechanicsPlainStrain::compute(int eflag, int vflag) {
...
void PairSPHSolidMechanicsPlainStrain::find_properties(int i) {
...
void PairSPHSolidMechanicsPlainStrain::compute_no_drho(int eflag, int vflag) {
...
bool PairSPHSolidMechanicsPlainStrain::check_f() {
...
void PairSPHSolidMechanicsPlainStrain::find_lambda_dot(int i) {
...
void PairSPHSolidMechanicsPlainStrain::find_sigma(int eflag, int vflag) {
...
void PairSPHSolidMechanicsPlainStrain::compute_drho(int eflag, int vflag) {
...
void PairSPHSolidMechanicsPlainStrain::allocate() {
  allocated = 1;
  int n = atom->ntypes;
...
void PairSPHSolidMechanicsPlainStrain::settings(int narg, char **arg) {
  if (narg != 0)
    error->all(FLERR,
...
void PairSPHSolidMechanicsPlainStrain::coeff(int narg, char **arg) {
  if (narg != 21)
...
double PairSPHSolidMechanicsPlainStrain::init_one(int i, int j) {
...
double PairSPHSolidMechanicsPlainStrain::single(int i, int j, int itype, int jtype,
